...
<%!
   ...
   {
	  pstmt = conn.prepareStatement("insert into tbl_user vales(?,?,?,?,?,?)");
      pstmt.setString(1, userDto.getUserid());
      pstmt.setString(2, userDto.getPassword());
      pstmt.setString(3, userDto.getUsername());
      pstmt.setString(4, userDto.getZipcode());
      pstmt.setString(5, userDto.getAdd1());
      pstmt.setString(6, userDto.getAdd2());
...
<%
	//
	String rul = (String)request.getAttribute("url");
